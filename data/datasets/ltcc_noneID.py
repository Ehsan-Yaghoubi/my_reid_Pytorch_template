...
class LTCC_noneID(BaseImageDataset):
    ...
    def __init__(self,root='', verbose=True, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'train_scratched')
        self.gallery_dir = osp.join(self.dataset_dir, 'test_scratched')
        self.query_dir = osp.join(self.dataset_dir, 'query_scratched')
    ...
    def _process_dir(self, dir_path, list_path):
        ...
        for img_idx, img_info in enumerate(list_path):
            ...
            dataset.append((img_path, person_id, camid))
